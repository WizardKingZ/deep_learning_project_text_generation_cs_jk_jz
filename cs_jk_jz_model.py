...
class FConvEncoder(FairseqEncoder):
    ...
    def __init__(
        ...
        self.fc3 = Linear(in_channels, embed_dim)
    ...
    def forward(self, src_tokens, src_lengths):
        ...
        mu = self.fc2(x)
        sigma = torch.abs(self.fc3(x))
        x = mu + sigma*torch.randn(self.embed_dim).cuda()
...
@register_model_architecture('cs_jk_jz_model', 'cs_jk_jz_model')
...
@register_model_architecture('cs_jk_jz_model', 'cs_jk_jz_model_wp')
